      ...
      initialMessages: [
        {
          ...
          role: 'assistant',
          content:
            'Olá! Sou o assistente de transparência política do Checa Aí. Posso te ajudar a entender votações parlamentares, gastos públicos, propostas legislativas e muito mais.\n\nO que você gostaria de saber sobre a política brasileira?',
        },
      ],
    });
  ...
  return (
    <div className="flex flex-col bg-white rounded-xl border shadow-sm overflow-hidden" style={{ height: 'calc(100vh - 220px)', minHeight: 480 }}>
      ...
      <div className="flex items-center gap-3 px-5 py-4 border-b bg-gradient-to-r from-civic-50 to-white">
        ...
        <div>
          <div className="font-semibold text-gray-900 text-sm">Checa Aí — Assistente Político</div>
